...
export class SupplierService {
  ...
  obtenerProveedores(
    ...
    if (filtros.taxId?.trim()) {
      params = params.set('taxId', filtros.taxId.trim());
    }
    ...
    return this.http.get<ApiResponse<ProveedorPage>>(this.apiUrl, { params });
  }
  ...
  crearProveedor(request: CrearProveedorRequest): Observable<ApiResponse<Proveedor>> {
    return this.http.post<ApiResponse<Proveedor>>(this.apiUrl, request);
  }
  ...
  actualizarProveedor(
    ...
    return this.http.put<ApiResponse<Proveedor>>(`${this.apiUrl}/${id}`, request);
  }
  ...
  actualizarEstado(
    ...
    const request: ActualizarEstadoProveedorRequest = { active };
